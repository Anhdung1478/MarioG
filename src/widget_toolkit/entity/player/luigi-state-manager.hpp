    ...
    class LuigiStateManager : public PlayerStateManager {
        ...
        public:
            ...
            void setClimbingAnimation(Animation *p_animation) override {
                ...
                p_animation->addAnimationStep(LUIGI_TYPE_STR[int(currStateType)] + ".climb[0]");
                p_animation->addAnimationStep(LUIGI_TYPE_STR[int(currStateType)] + ".climb[1]");
            ...
            void setBeingHitAnimation(Animation *p_animation) override {
                p_animation->clearAnimationStep();
                for (int i = 0; i < 15; ++i)
                    p_animation->addAnimationStep(LUIGI_TYPE_STR[int(currStateType)] + ".hit[" + std::to_string(i) + "]");
