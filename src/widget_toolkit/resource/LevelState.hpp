...
namespace mario::resource {
    struct LevelState {
        ...
        LevelState() : level(0), score(0), coins(0), num_lives(0), characterType(mario::entity::CharacterListType::Mario), stateType(mario::entity::player_state::PlayerStateType::Small) {};
