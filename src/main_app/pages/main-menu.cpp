...
mario::pages::MainMenuPage::MainMenuPage(mario::MainWindow &context) : Page(context) {
    ...
    p_levelButton[1]->Click.append([this]() {
        _context->changePage(std::make_shared<mario::pages::LevelsPage>(*_context, LevelState(1, 0, 0, 0)));
    });

    p_levelButton[2]->Click.append([this]() {
        _context->changePage(std::make_shared<mario::pages::LevelsPage>(*_context, LevelState(2, 0, 0, 0)));
    });

    p_levelButton[3]->Click.append([this]() {
        _context->changePage(std::make_shared<mario::pages::LevelsPage>(*_context, LevelState(3, 0, 0, 0)));
    });
