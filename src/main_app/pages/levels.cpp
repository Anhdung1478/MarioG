...
mario::pages::LevelsPage::LevelsPage(MainWindow &context, LevelState state) : Page(context) {
    ...
    p_player = std::make_unique<mario::entity::Player>(PREFIX_PATH"mario.json", PREFIX_PATH"mario_sheets.png", "mario-super.idle[0]", _context->getWorldId(), sf::Vector2f(500, 0));
